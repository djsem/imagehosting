...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="myth.500mb.net" /></td>
			<td><?php _e( 'You should be able to get this info from your web host, if <code>myth.500mb.net</code> does not work.' ); ?></td>
		</tr>
		<tr>
